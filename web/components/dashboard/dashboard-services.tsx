...
export async function fundAccount(connection: Connection,accountToFund: Keypair, lamports = LAMPORTS_PER_SOL) {
...
export async function createStakeAccount(connection: Connection,{ wallet, stakeAccount, lamports }: { wallet: Keypair, stakeAccount: Keypair, lamports?: number }) {
...
export async function delegateStakeAccount(connection: Connection,{ stakeAccount, validatorVoteAccount, authorized }: { stakeAccount: Keypair, validatorVoteAccount: PublicKey, authorized: Keypair }) {
...
export async function getStakeAccountInfo(connection: Connection,stakeAccount: PublicKey) {
    try {
...
export async function stakeAmount(connection: Connection,amountToStake: number) {
    try {
        ...
        await createStakeAccount(connection,{ wallet, stakeAccount, lamports: lamportsToStake });

        // Delegate the stake account to a validator vote account
        await delegateStakeAccount(connection,{ stakeAccount, validatorVoteAccount, authorized: wallet });
